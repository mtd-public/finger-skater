...
A one-thumb, isometric 3D skateboarding game for phones, in the spirit of
...
| --- | --- | --- | --- |
| **Drag** left / right | weave | drift a little | balance |
| **Hold** | charge an ollie (ring fills in ~0.8 s) | **grab** the board (trick) | charge a pop |
| **Release** | jump (a tap is a small hop, a full charge clears a car) | let go of the grab | pop off the rail |
...
- **Rail grinds.** Come down lined up on a rail (pavement or centre line) to
  ...
  centre, faster the longer you grind. Drag the other way to keep it centred.
  Pop off (tap) or ride to the end to bank 150 + 350/s. If the needle hits
  either end you slip off and take a hit.
...
| `js/input.js` | pointer and keyboard: drag and press/release events |
